...
我参与过很多顶级开源社区，包括 [sealer](https://github.com/sealerio/sealer) ⭐ 2,094 | 🐛 228 | 🌐 Go | 📅 2025-06-03、[sealos](https://github.com/labring/sealos) ⭐ 18,340 | 🐛 95 | 🌐 TypeScript | 📅 2026-09-04、[Kubernetes](https://github.com/kubernetes/kubernetes/) ⭐ 126,368 | 🐛 3,040 | 🌐 Go | 📅 2026-09-04、[OpenIM](https://github.com/OpenIMSDK)、[K8sgpt](https://github.com/k8sgpt-ai/k8sgpt) ⭐ 8,146 | 🐛 96 | 🌐 Go | 📅 2026-09-05、[Horizon](https://github.com/horizoncd/horizon/) ⭐ 257 | 🐛 4 | 🌐 Go | 📅 2026-06-17 以及 我自己打造的 开源社区 [Kubecub](https://github.com/kubecub)。kubecub 中有很多我沉淀下来的开源规范以及代码、项目规范都总结在各个仓库中。并且，Kubecub 和 OpenIM 使用了我创造的 [🤖 robot(kubbot)](https://github.com/kubbot) 来对 PR 和 Issue 高度自动化。kubecub 宗旨是面向所有的开发者进行学习和创造的，你可以在里面利用我们的自动化工具和模板打造自己的开源项目，并且让更多的人来帮助你协同、review 代码。
